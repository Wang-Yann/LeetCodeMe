...
class MyCalendarThree:
    ...
    def __str__(self):
        return "BOOKS:{}".format(self.__books)
...
def test_design():
    obj = MyCalendarThree()
    assert obj.book(10, 20) == 1  # returns 1
    assert obj.book(50, 60) == 1  # returns 1
    assert obj.book(10, 40) == 2  # returns 2
    assert obj.book(5, 15) == 3  # returns 3
    assert obj.book(5, 10) == 3  # returns 3
    assert obj.book(25, 55) == 3  # returns 3
    assert obj

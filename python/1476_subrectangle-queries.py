...
# -*- coding: utf-8 -*-
# @Author        : Rock Wayne 
# @Created       : 2020-07-10 15:19:56
# @Last Modified : 2020-07-10 15:19:56
...
@pytest.mark.parametrize("CLS", [SubrectangleQueries1, SubrectangleQueries])
def test_solution1(CLS):
    obj = CLS([[1, 2, 1], [4, 3, 4], [3, 2, 1], [1, 1, 1]])

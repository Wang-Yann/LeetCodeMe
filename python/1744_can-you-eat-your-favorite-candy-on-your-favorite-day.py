...
# -*- coding: utf-8 -*-
# @Author        : Rock Wayne 
# @Created       : 2021-02-27 14:39:02
# @Last Modified : 2021-02-27 14:39:02
...
class Solution:
    ...
    def canEat(self, candiesCount: List[int], queries: List[List[int]]) -> List[bool]:
        ...
        return [A[type_] // cap <= day < A[type_ + 1] for type_, day, cap in queries]
...
@pytest.mark.parametrize("kw,expected", [
    [dict(candiesCount=[7, 4, 5, 3, 8], queries=[[0, 2, 2], [4, 2, 4], [2, 13, 1000000000]]),
     [True, False, True]],
    [dict(candiesCount=[5, 2, 6, 4, 1], queries=[[3, 1, 2], [4, 10, 3], [3, 10, 100], [4, 100, 30], [1, 3, 1]]),
     [False, True, True, False, False]],

])
@pytest.mark.parametrize("SolutionCLS", [Solution, ])
def test_solutions(kw, expected, SolutionCLS):
    res = SolutionCLS().canEat(**kw)
    assert res == expected

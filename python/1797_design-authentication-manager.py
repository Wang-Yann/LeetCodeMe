...
# -*- coding: utf-8 -*-
# @Author        : Rock Wayne 
# @Created       : 2021-03-22 02:40:35
# @Last Modified : 2021-03-22 02:40:35
...
class AuthenticationManager:
    ...
    def renew(self, tokenId: str, currentTime: int) -> None:
        if tokenId in self.token and self.token[tokenId] > (currentTime - self.ttl):
            self.token[tokenId] = currentTime
...
@pytest.mark.parametrize("SolutionCLS", [AuthenticationManager, ])
def test_solutions(SolutionCLS):
    ops_list = ["AuthenticationManager", "renew", "generate", "countUnexpiredTokens", "generate",
                "renew", "renew", "countUnexpiredTokens"]
    args_list = [[5], ["aaa", 1], ["aaa", 2], [6], ["bbb", 7], ["aaa", 8], ["bbb", 10], [15]]
    out_list = [None, None, None, 1, None, None, None, 0]
    obj = SolutionCLS(5)

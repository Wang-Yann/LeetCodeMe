...
def test_design():
    ...
    assert obj.book(50, 60)  # returns true
    assert obj.book(10, 40)  # returns true
    assert not obj.book(5, 15)  # returns false
    assert obj.book(5, 10);  # returns true
    assert obj.book(25, 55)  # returns true

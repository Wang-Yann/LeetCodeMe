...
# -*- coding: utf-8 -*-
# @Author        : Rock Wayne 
# @Created       : 2021-02-25 06:18:30
# @Last Modified : 2021-02-25 06:18:30
...
@pytest.mark.parametrize("kw,expected", [
    [dict(inventory=[2, 5], orders=4), 14],
    [dict(inventory=[3, 5], orders=6), 19],
    [dict(inventory=[2, 8, 4, 10, 6], orders=20), 110],
    [dict(inventory=[1000000000], orders=1000000000), 21],
])
@pytest.mark.parametrize("SolutionCLS", [Solution, ])
def test_solutions(kw, expected, SolutionCLS):
    assert SolutionCLS().maxProfit(**kw) == expected

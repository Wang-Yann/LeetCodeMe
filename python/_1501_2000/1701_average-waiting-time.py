...
# -*- coding: utf-8 -*-
# @Author        : Rock Wayne 
# @Created       : 2021-02-26 07:44:03
# @Last Modified : 2021-02-26 07:44:03
...
@pytest.mark.parametrize("kw,expected", [
    [dict(customers=[[1, 2], [2, 5], [4, 3]]), 5.0],
    [dict(customers=[[5, 2], [5, 4], [10, 3], [20, 1]]), 3.25],
])
@pytest.mark.parametrize("SolutionCLS", [Solution, ])
def test_solutions(kw, expected, SolutionCLS):
    assert SolutionCLS().averageWaitingTime(**kw) == pytest.approx(expected, 1e-5)

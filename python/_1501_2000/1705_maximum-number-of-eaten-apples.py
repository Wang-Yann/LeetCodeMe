...
# -*- coding: utf-8 -*-
# @Author        : Rock Wayne 
# @Created       : 2021-02-26 08:56:48
# @Last Modified : 2021-02-26 08:56:48
...
@pytest.mark.parametrize("kw,expected", [
    [dict(apples=[1, 2, 3, 5, 2], days=[3, 2, 1, 4, 2]), 7],
    [dict(apples=[3, 0, 0, 0, 0, 2], days=[3, 0, 0, 0, 0, 2]), 5],
])
@pytest.mark.parametrize("SolutionCLS", [Solution, ])
def test_solutions(kw, expected, SolutionCLS):
    assert SolutionCLS().eatenApples(**kw) == expected
